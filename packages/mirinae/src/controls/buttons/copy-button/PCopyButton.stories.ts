...
import { getCopyButtonArgs, getCopyButtonArgTypes, getCopyButtonParameters } from '@/controls/buttons/copy-button/story-helper';
...
const meta : Meta<PCopyButtonPropsAndCustomArgs> = {
    title: 'Controls/Buttons/Copy Button',
