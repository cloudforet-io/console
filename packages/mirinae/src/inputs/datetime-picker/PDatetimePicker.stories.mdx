...
export const Template = (args, { argTypes }) => {
    ...
    <div class="h-full overflow p-8">
        ...
        <p-datetime-picker
            ...
            :data-type="dataType"
            :invalid="invalid"
            @update:selected-dates="onUpdateSelectedDates"
            @close="onClose"
        />
        <br>
...
<div>
    ...
    <p-select-dropdown v-model:selected="selectedDataType" :items="menu"/>
    <p class="py-2">Min Date = Today</p>
    <p-datetime-picker v-model:selected-dates="start" :min-date="now" :data-type="selectedDataType" />
    <p class="py-2">Max Date = Today</p>
    <p-datetime-picker v-model:selected-dates="end" :max-date="now" :data-type="selectedDataType" />
</div>
`,
    setup() {
        const state = reactive({
