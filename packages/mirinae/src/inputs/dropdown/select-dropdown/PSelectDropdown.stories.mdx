    ...
    <Story name="Using Custom Handler & Loading" args={{menu: getSelectDropdownMenuWithMultiTypes()}} height={'400px'}>
        {{
            ...
            <div>
                ...
                <p-select-dropdown :handler="menuHandlers" />
                <br/>
                <p class="text-label-lg font-bold my-3">With custom handler and loading</p>
                <p-select-dropdown :loading="loading" :handler="menuHandlers" />
                <br/>
                ...
                <br/>
                <p-select-dropdown :loading="loading" :handler="menuHandlers" :selected="selected" initSelectedWithHandler />
                <br/>
            </div>
`,
            setup() {
                ...
                return {
                    ...toRefs(state),
                    menuHandlers: [simpleHandler, simpleHandler],
                }
            }
        }}
    </Story>
