...
<Canvas>
    <Story name="Style Type" args={{menu: getFilterableDropdownMenu()}} height={'400px'}>
        {{
            props: Object.keys(getFilterableDropdownArgTypes()),
            components: { PFilterableDropdown },
            template: `
        <div>
            <p class="text-label-lg font-bold my-3">'basic' style type</p>
            <p-filterable-dropdown :menu="menu" />
            <br/>
            <p class="text-label-lg font-bold my-3">'rounded' style type</p>
            <p-filterable-dropdown :menu="menu" style-type="rounded" />
            <br/>
        </div>
`,
            setup(props) {
...
<Canvas>
    <Story name="Appearance Type" args={{menu: getFilterableDropdownMenu()}} height={'400px'}>
        ...
        <div>
            ...
            <p-filterable-dropdown :menu="menu" :selected="singleSelected" />
            <br/>
            ...
            <p-filterable-dropdown :menu="menu":selected="multiSelected"  multi-selectable />
            <br/>
            <p class="text-label-lg font-bold my-3">Multi select with 'badge' appearance type</p>
            <p-filterable-dropdown :menu="menu" :selected="multiSelected" multi-selectable appearance-type="badge" />
            <br/>
            <p class="text-label-lg font-bold my-3">Multi select with 'stack' appearance type</p>
            <p-filterable-dropdown :menu="menu" :selected="multiSelected" multi-selectable appearance-type="stack" />
            <br/>
    ...
    <Story name="Readonly & Disabled" args={{menu: getFilterableDropdownMenu()}} height={'400px'}>
        {{
            ...
            <div>
                ...
                <p-filterable-dropdown :menu="menu" :selected="selected"  />
                <br/>
                <p class="text-label-lg font-bold my-3">Disabled</p>
                <p-filterable-dropdown :menu="menu" :selected="selected" disabled />
                <br/>
                <p-filterable-dropdown :menu="menu" :selected="selected" multi-selectable appearance-type="badge" disabled />
                <br/>
                <p-filterable-dropdown :menu="menu" :selected="selected" multi-selectable appearance-type="stack" disabled />
                <br/>
                <p-filterable-dropdown :menu="menu" :selected="selected" disabled style-type="rounded" />
                <br/>
                <p class="text-label-lg font-bold my-3">Readonly</p>
                <p-filterable-dropdown :menu="menu" :selected="selected" readonly />
                <br/>
                <p-filterable-dropdown :menu="menu" :selected="selected" readonly style-type="rounded" />
                <br/>
            </div>
`,
            setup(props) {
    ...
    <Story name="Invalid" args={{menu: getFilterableDropdownMenu()}} height={'400px'}>
        {{
            ...
            <div>
                ...
                <p-filterable-dropdown :menu="menu" :selected="selected" invalid />
                <br/>
                <p-filterable-dropdown :menu="menu" :selected="selected" invalid style-type="rounded" />
                <br/>
            </div>
`,
            setup(props) {
...
<Canvas>
    <Story name="Selection Label" args={{menu: getFilterableDropdownMenu()}} height={'400px'}>
        {{
            props: Object.keys(getFilterableDropdownArgTypes()),
            components: { PFilterableDropdown },
            template: `
            <div>
                ...
                <p-filterable-dropdown :menu="menu" selection-label="Label" />
                <br/>
            </div>
`,
        }}
...
<Canvas>
    <Story name="Selection Highlight" args={{menu: getFilterableDropdownMenu()}} height={'500px'}>
        {{
            props: Object.keys(getFilterableDropdownArgTypes()),
            components: { PFilterableDropdown },
            template: `
                ...
                <p-filterable-dropdown :menu="menu" :selected="selected" selection-highlight />
                <br/>
                <p-filterable-dropdown :menu="menu" :selected="selected" selection-highlight style-type="rounded" />
                <br/>
                <p class="text-label-lg font-bold my-3">Show selection highlight at badge type</p>
                <p-filterable-dropdown :menu="menu" :selected="selected" multi-selectable appearance-type="badge" selection-highlight/>
                <br/>
                <p class="text-label-lg font-bold my-3">Show selection highlight at badge type with selection label</p>
                <p-filterable-dropdown :menu="menu" :selected="selected" multi-selectable appearance-type="badge" selection-label="Label" selection-highlight/>
                <br/>
                <p class="text-label-lg font-bold my-3">Show selection highlight at stack type</p>
                <p-filterable-dropdown :menu="menu" :selected="selected" multi-selectable appearance-type="stack" selection-highlight/>
                <br/>
                <p class="text-label-lg font-bold my-3">Show selection highlight at stack type with selection label</p>
                <p-filterable-dropdown :menu="menu" :selected="selected" multi-selectable appearance-type="stack" selection-label="Label" selection-highlight/>
                <br/>
                </div>
            `,
            setup(props) {
...
<Canvas>
    <Story name="Show Alert Dot" args={{menu: getFilterableDropdownMenuWithMultiTypes()}} height={'400px'}>
        {{
            props: Object.keys(getFilterableDropdownArgTypes()),
            ...
            <div>
                ...
                <p-filterable-dropdown :menu="menu" show-alert-dot />
                <br/>
                <p class="text-label-lg font-bold my-3">Show Alert Dot and Selection Highlight at Badge Type</p>
                <p-filterable-dropdown :menu="menu" :selected="selected" multi-selectable show-alert-dot selection-highlight appearance-type="badge"/>
                <br/>
            </div>
`,
            setup(props) {
...
<Canvas>
    <Story name="Show Delete All Button" args={{menu: getFilterableDropdownMenuWithMultiTypes()}} height={'400px'}>
        {{
            props: Object.keys(getFilterableDropdownArgTypes()),
            components: { PFilterableDropdown, PButton },
            template: `
            <div>
                ...
                <p-filterable-dropdown :menu="menu" :show-delete-all-button="false" />
                <br/>
            </div>
`,
        }}
    ...
    <Story name="Using Custom Handler & Loading" args={{menu: getFilterableDropdownMenuWithMultiTypes()}} height={'400px'}>
        {{
            ...
            <div>
                ...
                <br/>
                <p-filterable-dropdown :loading="loading" :handler="simpleHandler" :selected="selected" initSelectedWithHandler />
                <br/>
            </div>
`,
            setup() {
