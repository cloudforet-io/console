...
export const Template = (args, { argTypes }) => ({
    ...
    components: { PSearch },
    template: `
        <p-search v-model:value="proxyValue"
                  v-bind="inputAttrs"
...
<Canvas>
    <Story name="Invalid" >
        {{
            components: { PSearch },
            template: `
        <p-search v-model:value="proxyValue" invalid/>
    `,
            setup(props) {
                const state = reactive({
                    proxyValue: props.value
...
<Canvas>
    <Story name="Disabled" >
        {{
            components: { PSearch },
            template: `
        <p-search v-model:value="proxyValue" disabled/>
    `,
            setup(props) {
                const state = reactive({
                    proxyValue: props.value
...
<Canvas>
    <Story name="Readonly" >
        {{
            components: { PSearch },
            template: `
        <p-search v-model:value="proxyValue" readonly />
    `,
            setup(props) {
                const state = reactive({
                    proxyValue: props.value
