...
<Canvas>
    <Story name="Use Hash Scroll">
        {{
            components: { PLink },
            router,
            template: `
            <div>
                <p-link class='block' highlight href="#first" use-hash-scroll>First Section</p-link>
                <p-link class='block' highlight href="#second"  use-hash-scroll>Second Section</p-link>
