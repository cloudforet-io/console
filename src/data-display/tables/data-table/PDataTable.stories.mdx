...
|textAlign|If you want to align text in the cell, give the value.|



cost management widgets

- cost analysis dynamic widget -> cost dashboard > custom widget 에 쓰임
- cost dashboard widgets. e.g. cost trend by product
--> spaceone dashboard
