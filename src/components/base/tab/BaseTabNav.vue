                ...
                <slot name="footerArea">
                    <div class="col-md-12 mt-4">
                        <div v-show="isFooterVisible" class="modal-footer" style="border-top:none; padding-right: 5px">
                            ...
                            <b-button v-show="isCreatable" size="md" variant="outline-primary"
                                      @click="createNew"
                            >
                                {{ tr('BTN_CRT') }}
                            </b-button>
                            <b-button v-show="isUpdatable" size="md" variant="outline-primary"
                                      @click="updateSelect"
                            >
                                {{ tr('BTN_UPT') }}
                            </b-button>
                            <b-button v-show="isDeletable" size="md" variant="outline-danger"
                                      @click="deleteSelect"
                            >
                                {{ tr('BTN_DELETE') }}
                            </b-button>
