...
|array|ajv|[Text Input](?path=/docs/inputs-input--basic) or [Search Dropdown](?path=/docs/inputs-dropdown-search-dropdown--basic)(with enum keyword)||
...
|items|custom|[Search Dropdown](?path=/docs/inputs-dropdown-search-dropdown--basic)|supports `array` type only|
