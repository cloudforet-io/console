...
<div>
    ...
    <p-datetime-picker data-type="yearToTime" timezone="UTC" :selected-dates.sync="selectedUTCDates" />
    <br/><br/>
    <p>Asia/Seoul (GMT+9)</p>
    <p>{{ selectedSeoulDates }}</p>
    <p-datetime-picker data-type="yearToTime" timezone="Asia/Seoul" :selected-dates.sync="selectedSeoulDates" />
    <br/><br/>
    <p>America/New_York (GMT-4)</p>
    <p>{{ selectedNewYorkDates }}</p>
    <p-datetime-picker data-type="yearToTime" timezone="America/New_York" :selected-dates.sync="selectedNewYorkDates" />
</div>
`,
            setup() {
                const state = reactive({
