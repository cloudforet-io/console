...
<Meta title='Inputs/Dropdown/Search Dropdown' parameters={{
    design: {
        type: 'figma',
...
<Canvas>
    <Story name="Multi Selectable" args={{menu: getSearchDropdownMenu()}}>
        {{
            ...
            components: { PSearchDropdown },
            template: `
        <p-search-dropdown :menu="menu" :multi-selectable="true" use-fixed-menu-style />
`,
        }}
    </Story>
</Canvas>
...
<Canvas>
    <Story name="Multi Selectable With no Delete All Button" args={{menu: getSearchDropdownMenu()}}>
        {{
            ...
            components: { PSearchDropdown },
            template: `
        <p-search-dropdown :menu="menu" :multi-selectable="true" :disable-delete-all="true" use-fixed-menu-style />
`,
        }}
    </Story>
</Canvas>
