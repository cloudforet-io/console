...
<Canvas>
    <Story name="Button Type">
        {{
            ...
            template: `
    <div class="h-full w-full overflow p-8">
        <p-select-dropdown v-for="buttonStyle in buttonStyles" :key="buttonStyle" :items="menuItems" :type="SELECT_DROPDOWN_TYPE.BUTTON" :button-style-type="buttonStyle" style="margin: 0.5rem;"></p-select-dropdown>
    </div>
    `,
            setup() {
                return {
...
<Canvas>
    <Story name="Outline Button Type">
        {{
            ...
            template: `
    <div class="h-full w-full overflow p-8">
        <p-select-dropdown v-for="buttonStyle in buttonStyles" :key="buttonStyle" :items="menuItems" :type="SELECT_DROPDOWN_TYPE.OUTLINE_BUTTON" :button-style-type="buttonStyle" style="margin: 0.5rem;"></p-select-dropdown>
    </div>
    `,
            setup() {
                return {
...
<table style="border-collapse: separate; border-spacing: 16px;">
    ...
    <tbody>
        <tr>
            <th>default</th>
            <td><p-select-dropdown :items="menuItems" :type="SELECT_DROPDOWN_TYPE.ICON_BUTTON" /></td>
            <td><p-select-dropdown :items="menuItems" :type="SELECT_DROPDOWN_TYPE.ICON_BUTTON" disabled /></td>
            <td><p-select-dropdown :items="menuItems" :type="SELECT_DROPDOWN_TYPE.ICON_BUTTON" invalid /></td>
        </tr>
        <tr>
            <th>custom</th>
            <td><p-select-dropdown :items="menuItems" :type="SELECT_DROPDOWN_TYPE.ICON_BUTTON" button-icon="ic_setting" /></td>
            <td><p-select-dropdown :items="menuItems" :type="SELECT_DROPDOWN_TYPE.ICON_BUTTON" button-icon="ic_setting" disabled /></td>
            <td><p-select-dropdown :items="menuItems" :type="SELECT_DROPDOWN_TYPE.ICON_BUTTON" button-icon="ic_setting" invalid /></td>
        </tr>
    </tbody>
</table>
    `,
