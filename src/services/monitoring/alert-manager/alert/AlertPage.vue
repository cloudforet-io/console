...
import NewAssignedAlertListCard from '@/services/monitoring/alert-manager/alert/modules/NewAssignedAlertListCard.vue';
import AlertDataTable from '@/services/monitoring/alert-manager/alert/modules/AlertDataTable.vue';
import AssignedAlertInfoPanel from '@/services/monitoring/alert-manager/alert/modules/AssignedAlertInfoPanel.vue';
