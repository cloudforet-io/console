...
import AlertActions from '@/services/monitoring/alert-manager/alert/modules/AlertActions.vue';
import AlertTableBottomFilters from '@/services/monitoring/alert-manager/alert/modules/AlertTableBottomFilters.vue';
import AlertFormModal from '@/services/monitoring/alert-manager/alert/modules/AlertFormModal.vue';
import {
