...
import CloudServiceMenu from '@/services/asset-management/cloud-service/modules/CloudServiceMenu.vue';
import CloudServiceToolbox from '@/services/asset-management/cloud-service/modules/CloudServiceToolbox.vue';
...
import CloudServiceListCard
    from '@/services/asset-management/cloud-service/modules/cloud-service-list/CloudServiceListCard.vue';
