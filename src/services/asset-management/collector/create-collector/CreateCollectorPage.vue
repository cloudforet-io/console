...
import ConfirmCredentials from '@/services/asset-management/collector/create-collector/modules/ConfirmCredentials.vue';
import { UPGRADE_MODE } from '@/services/asset-management/collector/type';
...
export default {
    ...
    setup(props, { root }) {
        ...
        const onClickBackButton = () => {
            vm.$router.push({ name: ASSET_MANAGEMENT_ROUTE.COLLECTOR.CREATE._NAME });
        };
        const onClickCancel = () => {
            vm.$router.go(-1);
        };
        const onClickConfirm = async () => {
            ...
            try {
                ...
                await vm.$router.push({ name: ASSET_MANAGEMENT_ROUTE._NAME });
            } catch (e) {
