            ...
            <template #container="{ height }">
                ...
                >
                    <template #toolbox-left>
                        <router-link :to="{ name: ASSET_MANAGEMENT_ROUTE.COLLECTOR.CREATE.PLUGINS._NAME }">
...
import { CollectorModel } from '@/services/asset-management/collector/type';
...
const CollectorUpdateModal = (): Component => import('@/services/asset-management/collector/modules/CollectorUpdateModal.vue') as Component;
const CollectDataModal = (): Component => import('@/services/asset-management/collector/modules/CollectDataModal.vue') as Component;
const CollectorDetails = (): Component => import('@/services/asset-management/collector/modules/CollectorDetails.vue') as Component;
const CollectorCredentials = (): Component => import('@/services/asset-management/collector/modules/CollectorCredentials.vue') as Component;
const CollectorSchedules = (): Component => import('@/services/asset-management/collector/modules/CollectorSchedules.vue') as Component;
