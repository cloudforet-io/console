        ...
        >
            ...
            <template #confirm-button>
                <p-icon-text-button
                    ...
                    name="ic_plus_bold"
                    @click="$router.push({ name: ASSET_MANAGEMENT_ROUTE.COLLECTOR.CREATE._NAME })"
                >
...
import PCollectorHistoryChart from '@/services/asset-management/collector-history/modules/CollectorHistoryChart.vue';
...
import { JOB_STATUS } from '@/services/asset-management/collector-history/lib/config';
