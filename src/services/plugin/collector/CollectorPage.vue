...
import { CollectorModel } from '@/services/plugin/collector/type';
...
const CollectorUpdateModal = (): Component => import('@/services/plugin/collector/modules/CollectorUpdateModal.vue') as Component;
const CollectDataModal = (): Component => import('@/services/plugin/collector/modules/CollectDataModal.vue') as Component;
const CollectorDetails = (): Component => import('@/services/plugin/collector/modules/CollectorDetails.vue') as Component;
const CollectorCredentials = (): Component => import('@/services/plugin/collector/modules/CollectorCredentials.vue') as Component;
const CollectorSchedules = (): Component => import('@/services/plugin/collector/modules/CollectorSchedules.vue') as Component;
