    ...
    setup() {
        ...
        const state = reactive({
            ...
            fields: computed(() => ([
                ...
                { name: 'user_type', label: 'Access Control', sortable: true },
                { name: 'api_key_count', label: 'API Key' },
                { name: 'role_name', label: 'Role' },
                { name: 'tags', label: 'Tags' },
                { name: 'backend', label: 'Auth Type', sortable: true },
                { name: 'last_accessed_at', label: 'Last Activity', sortable: true },
                { name: 'timezone', label: 'Timezone', sortable: true },
            ])),
            excelFields: [
