...
import SpotGroupDetailDashboard from '@/services/automation/spot-automation/spot-group/spot-group-detail/modules/SpotGroupDetailDashboard.vue';
import {
    PBreadcrumbs, PPageTitle, PIconButton, PTab, PButtonModal, PTextInput, PFieldGroup,
} from '@spaceone/design-system';
import { TabItem } from '@spaceone/design-system/dist/src/navigation/tabs/tab/type';

import SpotGroupDetailMember from '@/services/automation/spot-automation/spot-group/spot-group-detail/modules/SpotGroupDetailMember.vue';
