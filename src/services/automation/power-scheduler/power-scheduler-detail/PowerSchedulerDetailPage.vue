...
import ScheduleDetail from '@/services/automation/power-scheduler/power-scheduler-detail/modules/ScheduleDetail.vue';
import { SCHEDULE_STATUS, Schedule } from '@/services/automation/power-scheduler/type';
