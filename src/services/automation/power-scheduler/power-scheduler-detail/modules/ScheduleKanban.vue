...
import ResourceGroupPage from '@/services/automation/power-scheduler/power-scheduler-detail/resource-group/ResourceGroupPage.vue';
import { KanbanItem, ViewMode, ResourceGroupItem } from '@/services/automation/power-scheduler/type';
