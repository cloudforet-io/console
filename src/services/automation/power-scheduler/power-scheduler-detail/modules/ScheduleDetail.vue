...
import ScheduleTimeTable from '@/services/automation/power-scheduler/power-scheduler-detail/modules/ScheduleTimeTable.vue';
import ScheduleKanban from '@/services/automation/power-scheduler/power-scheduler-detail/modules/ScheduleKanban.vue';

import {
    defaultSchedule, SCHEDULE_STATUS, Schedule, ViewMode,
} from '@/services/automation/power-scheduler/type';
