...
/* Page Modules */
import PageInformation from '@/services/automation/power-scheduler/modules/PageInformation.vue';
import ScheduleHeatmap from '@/services/automation/power-scheduler/modules/ScheduleHeatmap.vue';
