...
import PBadge from "@/atoms/badges/PBadge";
import {BADGE_SHAPE, BADGE_STYLE} from "@/atoms/badges/type";

<Meta title='Data Display/Badges' component={PBadge} argTypes={{
    styleType: {
        name: 'styleType',
        type: {name: 'string'},
