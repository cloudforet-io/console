...
export type PoolListResp = ListType<any>
...
class List extends ListAction<any, PoolListResp> {}
export default class Pool extends Resource implements ResourceActions<'create'|'update'|'delete'|'get'|'list'> {
    protected name = 'pool';
