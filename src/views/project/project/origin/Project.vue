...
import ProjectContext from '@/views/project/project/origin/ProjectContext';
...
const projectSummaryTop = () => import('@/views/project/project/origin/ProjectSummaryTop');
const projectSummaryBottom = () => import('@/views/project/project/origin/ProjectSummaryBottom');
const projectMember = () => import('@/views/project/project/origin/ProjectMember');
const ProjectContextAction = () => import('@/views/project/project/origin/ProjectContextAction');
