...
<!--        <kanban-test />-->
<!--&lt;!&ndash;        <div v-for="(num, priority) in maxPriority" :key="priority">&ndash;&gt;-->
<!--&lt;!&ndash;            <div class="resource-group-box">&ndash;&gt;-->
<!--&lt;!&ndash;                <div class="resource-group-header">&ndash;&gt;-->
<!--&lt;!&ndash;                    <span id="header-number">{{ num }}</span>&ndash;&gt;-->
<!--&lt;!&ndash;                    <div v-if="num === 1" class="header-decorator">&ndash;&gt;-->
<!--&lt;!&ndash;                        높음&ndash;&gt;-->
<!--&lt;!&ndash;                    </div>&ndash;&gt;-->
<!--&lt;!&ndash;                    <span v-if="num === 1" id="header-priority">우선순</span>&ndash;&gt;-->
<!--&lt;!&ndash;                    <div v-if="num === maxPriority" class="header-decorator">&ndash;&gt;-->
<!--&lt;!&ndash;                        낮음&ndash;&gt;-->
<!--&lt;!&ndash;                    </div>&ndash;&gt;-->
<!--&lt;!&ndash;                </div>&ndash;&gt;-->

<!--&lt;!&ndash;                <div v-for="(resource, idx) in resourceGroup" :key="idx" class="resource-group-item">&ndash;&gt;-->
<!--&lt;!&ndash;                    <div v-if=" resource.priority === num" class="resource">&ndash;&gt;-->
<!--&lt;!&ndash;                        <p-lazy-img :src="iconUrl(resource)"&ndash;&gt;-->
<!--&lt;!&ndash;                                    width="2rem" height="2rem"&ndash;&gt;-->
<!--&lt;!&ndash;                                    class="mr-2"&ndash;&gt;-->
<!--&lt;!&ndash;                        />&ndash;&gt;-->
<!--&lt;!&ndash;                        <span class="resource-description">&ndash;&gt;-->
<!--&lt;!&ndash;                            {{ resource.name }} <br> ({{ resource.count }})&ndash;&gt;-->
<!--&lt;!&ndash;                        </span>&ndash;&gt;-->
<!--&lt;!&ndash;                    </div>&ndash;&gt;-->
<!--&lt;!&ndash;                </div>&ndash;&gt;-->
<!--&lt;!&ndash;            </div>&ndash;&gt;-->
...
<!--export default {-->
<!--    name: 'ScheduleKanban',-->
<!--    components: { PLazyImg, KanbanTest },-->
<!--    props: {-->
<!--        scheduleId: {-->
<!--            type: String,-->
<!--            required: true,-->
...
<!--            for (let i = 1; i <= state.maxPriority; i++ ) {-->
<!--                state.columns.push(i);-->
<!--            }-->
<!--        };-->

<!--        const getResourceGroupInfo = async () => {-->
<!--            for (let i = 0; i < Object.keys(state.resourceGroup).length; i++) {-->
