...
import CollectorDetails from '@/views/inventory/collector/modules/CollectorDetailsSingle';
import CollectorCredentials from '@/views/inventory/collector/modules/CollectorCredentials';
import CollectorCollectData from '@/views/inventory/collector/modules/CollectorCollectData';
import CollectorJobs from '@/views/inventory/collector/modules/CollectorJobs';
import ActionCheckModal from '@/components/base/modal/ActionCheckModal.vue';
import CollectorSchedule from '@/views/inventory/collector/modules/CollectorSchedule';
