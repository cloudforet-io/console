<template>
    <div>
        <BaseModal
            ref="IVCO002_CollectorActionModal"
        ...
        <b-row>
            <b-col class="col-xs-12 col-sm-3 col-md-3">
                <b-card class="left-container">
                    <b-row>
                        <div
                            ref="IVCO002_SearchboxContainer"
                    ...
                    <b-row>
                        ...
                        >
                            <b-form-radio
                                v-model="repositoryData.selectedRepo"
                                name="radio-size"
                                size="lg"
                                value="OFFICIAL"
                                @change="listCollectPlugin"
                            >
                                {{ tr('PANEL.OFFICIAL') }}
                            </b-form-radio>
                            <b-form-radio
            ...
            <b-col class="col-xs-12 col-sm-9 col-md-9">
                <b-card class="right-container">
                    ...
                    <b-row>
                        <b-col
                            v-for="(plugIn, idx) in getPlugInList"
                            :key="idx"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <b-form>
                                        <b-form-radio
                                            v-model="plugInList.plugInDataSelected.selected_id"
                                            class="mb-3"
                                            :value="plugIn.plugin_id"
                                        >
                                            {{ plugIn.name }}
                                        ...
                                        <BaseField
                                            v-model="plugInList.plugInDataSelected.selected_version[replaceAll(plugIn.plugin_id, '-', '_')]"
...
export default {
    ...
    computed: {
        ...
        getPlugInDropDown() {
            return index => this.plugInList.plugInData[index].plugin_ver;
        },
        searchboxWidth() {
            if (this.searchWidth) {
    ...
    methods: {
        ...
        createComboBox(versionArr) {
            ...
            if (versionArr.length > 0) {
                ...
                versionArr.forEach((curItem, index) => {
                    returnVal.push({
                        value: curItem,
