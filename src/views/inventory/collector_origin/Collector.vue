...
import BaseMultiPanel from '@/components/base/panel/BaseMultiPanel';
import BaseModal from '@/components/base/modal/BaseModal';

import CollectorDetails from '@/views/inventory/collector_origin/modules/CollectorDetailsSingle';
import CollectorCredentials from '@/views/inventory/collector_origin/modules/CollectorCredentials';
import CollectorCollectData from '@/views/inventory/collector_origin/modules/CollectorCollectData';
import CollectorJobs from '@/views/inventory/collector_origin/modules/CollectorJobs';
import ActionCheckModal from '@/components/base/modal/ActionCheckModal.vue';
import CollectorSchedule from '@/views/inventory/collector_origin/modules/CollectorSchedule';
        ...
        fields() {
            return [
                ...
                },
                {
                    ...
                    label: this.tr('COL_NM.LAST_COL'),
                    sortable: true,
                    ajaxSortable: true,
                    filterByFormatted: true,
                    formatter: val => this.getComputedTime(val),
                    thStyle: { width: '200px' },
                },
                {
                    key: 'created_at',
