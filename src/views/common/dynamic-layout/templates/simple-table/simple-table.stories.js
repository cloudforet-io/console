...
import SDynamicLayoutSimpleTable from '@/views/common/dynamic-layout/templates/simple-table/index.vue';

import { object } from '@storybook/addon-knobs';
import md from '@/views/common/dynamic-layout/SDynamicLayout.md';
