...
import SDynamicLayoutTable from '@/views/common/dynamic-layout/templates/table/index.vue';


import { computed, ref } from '@vue/composition-api';
import md from '@/views/common/dynamic-layout/templates/table/table.md';
import PButton from '@/components/atoms/buttons/PButton.vue';
import { fluentApi } from '@/lib/fluent-api';

export default {
    title: 'organisms/dynamic-view/dynamic-layout/query-search-table',
