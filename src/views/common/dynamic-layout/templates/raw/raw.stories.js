...
import SDynamicLayoutRaw from '@/views/common/dynamic-layout/templates/raw/index.vue';

import { object } from '@storybook/addon-knobs';
import { ref } from '@vue/composition-api';
import md from '@/views/common/dynamic-layout/templates/item/item.md';
import { fluentApi } from '@/lib/fluent-api';

export default {
    title: 'organisms/dynamic-view/dynamic-layout/raw',
