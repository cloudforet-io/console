                ...
                <b-col sm="6">
                  <Callout variant="info">
                    ...
                    <div
                      ...
                      :style="{ top: '-10px'}"
                    >
                      <!--<callout-charts-example :data="[35, 23, 56, 22, 97, 23, 64]" variant="#20a8d8" width="80" height="30" />-->
                      <callout-chart-example
                        chart-id="callout-chart-01"
                        :data="[35, 23, 56, 22, 97, 23, 64]"
                        variant="info"
                        width="80"
                        height="30"
