...
export const MENU_INFO_MAP: Record<MenuId, MenuInfo> = Object.freeze({
    ...
    [MENU_ID.BASE_INFORMATION]: {
        menuId: MENU_ID.BASE_INFORMATION,
        routeName: PREFERENCE_ROUTE.DOMAIN_SETTINGS.BASE_INFORMATION._NAME,
        translationId: 'IAM.DOMAIN_SETTINGS.BASE_INFORMATION',
    },

    [MENU_ID.BRAND_ASSETS]: {
        menuId: MENU_ID.BRAND_ASSETS,
        routeName: PREFERENCE_ROUTE.DOMAIN_SETTINGS.BRAND_ASSETS._NAME,
        translationId: 'IAM.DOMAIN_SETTINGS.BRAND_ASSETS',
    },

    [MENU_ID.TIMEZONE_AND_LANGUAGE]: {
        menuId: MENU_ID.TIMEZONE_AND_LANGUAGE,
        routeName: PREFERENCE_ROUTE.DOMAIN_SETTINGS.TIMEZONE_AND_LANGUAGE._NAME,
        translationId: 'IAM.DOMAIN_SETTINGS.TIMEZONE_AND_LANGUAGE',
    },
