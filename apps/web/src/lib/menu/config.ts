...
export const MENU_ID = Object.freeze({
    ...
    COST_ANOMALY_DETECTION_CONFIGURATION: 'cost_anomaly_detection_configuration',
    COST_ANOMALY_DETECTION_POLICY: 'cost_anomaly_detection_policy',
    COST_ANOMALY_DETECTION_HISTORY: 'cost_anomaly_detection_history',
    BUDGET: 'budget',
