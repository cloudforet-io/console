...
export const MENU_ID = Object.freeze({
    ...
    ADMINISTRATION_PREFERENCE: 'administration.preference',
    ADMINISTRATION_DOMAIN_SETTINGS: 'administration.domain_settings',
    ADMINISTRATION_WORKSPACES: 'administration.workspaces',
    MY_PAGE: 'my_page',
