...
export const useProtocolApi = () => {
    const actions = {
        ...
        disable: SpaceConnector.clientV2.notification.protocol.disable<ProtocolDisableParameters>,
        enable: SpaceConnector.clientV2.notification.protocol.enable<ProtocolEnableParameters>,
