...
import type { WorkspaceGroupUserModel, WorkspaceGroupUserSummaryModel } from '@/api-clients/identity/workspace-group-user/schema/model';
...
export const useWorkspaceGroupUserApi = () => {
    const actions = {
        ...
        find: SpaceConnector.clientV2.identity.workspaceGroupUser.find<WorkspaceGroupUserFindParameters, ListResponse<WorkspaceGroupUserSummaryModel>>,
