...
export const useWorkspaceReferenceStore = defineStore('workspace-reference', () => {
    ...
    const getters = reactive({
        ...
        workspaceTypeInfo: computed<ReferenceTypeInfo>(() => ({
            type: MANAGED_VARIABLE_MODELS.workspace.prototype.meta.key,
            key: MANAGED_VARIABLE_MODELS.workspace.prototype.meta.idKey,
            name: MANAGED_VARIABLE_MODELS.workspace.prototype.meta.name,
