...
export const useCostDataSourceReferenceStore = defineStore('cost-data-source-reference-store', () => {
    ...
    const getters = reactive({
        ...
        costDataSourceTypeInfo: computed<ReferenceTypeInfo>(() => ({
            type: MANAGED_VARIABLE_MODELS.cost_data_source.prototype.meta.key,
            key: MANAGED_VARIABLE_MODELS.cost_data_source.prototype.meta.idKey,
            name: MANAGED_VARIABLE_MODELS.cost_data_source.prototype.meta.name,
