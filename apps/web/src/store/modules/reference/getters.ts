...
import type { VuexAllReferenceTypeInfo } from '@/store/modules/reference/type';
...
export const allReferenceTypeInfo: Getter<any, any> = (state, getters): VuexAllReferenceTypeInfo => ({
    projectGroup: {
