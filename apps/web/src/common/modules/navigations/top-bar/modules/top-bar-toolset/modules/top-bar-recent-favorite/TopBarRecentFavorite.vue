<template>
    ...
    >
        ...
        >
            <template #recent>
                <top-bar-recent :visible="visible && activeTab === 'recent'"
...
import TopBarFavorite
    from '@/common/modules/navigations/top-bar/modules/top-bar-toolset/modules/top-bar-recent-favorite/modules/TopBarFavorite.vue';
import TopBarRecent
    from '@/common/modules/navigations/top-bar/modules/top-bar-toolset/modules/top-bar-recent-favorite/modules/TopBarRecent.vue';

interface Props {
    visible: boolean
}
export default defineComponent<Props>({
    name: 'TopBarRecentFavorite',
    components: {
        TopBarRecent,
        TopBarFavorite,
        PI,
