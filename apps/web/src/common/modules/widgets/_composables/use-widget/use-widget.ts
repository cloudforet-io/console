...
import type {
    BaseWidgetState,
} from '@/common/modules/widgets/_composables/use-widget/use-base-widget-state';
import { useBaseWidgetState } from '@/common/modules/widgets/_composables/use-widget/use-base-widget-state';
import { useWidgetConsoleFilters } from '@/common/modules/widgets/_composables/use-widget/use-widget-console-filters';
import { useWidgetDateRange } from '@/common/modules/widgets/_composables/use-widget/use-widget-date-range';
import { useWidgetFrame } from '@/common/modules/widgets/_composables/use-widget/use-widget-frame';
import { useWidgetLocation } from '@/common/modules/widgets/_composables/use-widget/use-widget-location';
import type { WidgetEmit, WidgetProps } from '@/common/modules/widgets/_types/widget-type';
