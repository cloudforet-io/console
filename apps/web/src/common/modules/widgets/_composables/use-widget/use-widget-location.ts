...
import { getWidgetLocationFilters } from '@/common/modules/widgets/_helpers/widget-location-helper';
import type { WidgetProps } from '@/common/modules/widgets/_types/widget-type';
