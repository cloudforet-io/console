...
import type { ComplianceStatus, Severity } from '@/common/modules/widgets/_types/compliance-type';
import type { WidgetExpose, WidgetProps, WidgetEmit } from '@/common/modules/widgets/_types/widget-type';
