...
import WidgetDataTable from '@/common/modules/widgets/_components/WidgetDataTable.vue';
import WidgetFrame from '@/common/modules/widgets/_components/WidgetFrame.vue';
import { useWidgetColorSet } from '@/common/modules/widgets/_composables/use-widget-color-set';
import { useWidgetLifecycle } from '@/common/modules/widgets/_composables/use-widget-lifecycle';
import { useWidgetPagination } from '@/common/modules/widgets/_composables/use-widget-pagination';
import { useWidget } from '@/common/modules/widgets/_composables/use-widget/use-widget';
import { getRefinedXYChartData } from '@/common/modules/widgets/_helpers/widget-chart-data-helper';
import { getXYChartLegends } from '@/common/modules/widgets/_helpers/widget-chart-helper';
import { getWidgetDataTableRowLocation } from '@/common/modules/widgets/_helpers/widget-location-helper';
import { getReferenceTypeOfDataField } from '@/common/modules/widgets/_helpers/widget-table-helper';
import { getWidgetValueLabel } from '@/common/modules/widgets/_helpers/widget-value-label-helper';
import type { Field, WidgetTableData } from '@/common/modules/widgets/_types/widget-data-table-type';
import type {
