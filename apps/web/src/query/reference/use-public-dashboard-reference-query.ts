...
import { useReferenceQuery } from '@/query/reference/_composables/use-reference-query';
import { useReferenceQueryKey } from '@/query/reference/_composables/use-reference-query-key';
import type { ReferenceItem, ReferenceMap } from '@/query/reference/_types/reference-type';
