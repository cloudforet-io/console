...
import { REFERENCE_TYPE_MAP } from '@/query/reference/_constants/reference-type-map';


type UseReferenceQueryKeyResult = Record<keyof typeof REFERENCE_TYPE_MAP, QueryKeyArray>;
...
export const useReferenceQueryKey = (): ComputedRef<UseReferenceQueryKeyResult> => {
    ...
    return computed(() => Object.entries(REFERENCE_TYPE_MAP).reduce((acc, [key, value]) => ({
        ...acc,
