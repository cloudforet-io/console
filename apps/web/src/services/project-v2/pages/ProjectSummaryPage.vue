...
import ProjectSummaryServiceAccountsWidget from '@/services/project-v2/components/ProjectSummaryServiceAccountsWidget.vue';
import ProjectSummaryTrustedAdvisorWidget from '@/services/project-v2/components/ProjectSummaryTrustedAdvisorWidget.vue';
