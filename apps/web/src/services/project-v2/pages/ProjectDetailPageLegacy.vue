...
import ProjectMainProjectGroupMoveModal from '@/services/project-v2/components/ProjectMainProjectGroupMoveModal.vue';
...
const handleGoBackProjectLanding = () => {
    router.push(getProperRouteLocation({ name: PROJECT_ROUTE_V2._NAME, params: { projectGroupId: state.projectGroupId } }));
};
