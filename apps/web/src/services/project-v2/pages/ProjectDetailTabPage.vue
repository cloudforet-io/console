...
import ProjectDetailTab from '@/services/project-v2/components/ProjectDetailTab.vue';
import ProjectDetailTabHeader from '@/services/project-v2/components/ProjectDetailTabHeader.vue';
import { PROJECT_ROUTE_V2 } from '@/services/project-v2/routes/route-constant';
import { useProjectDetailPageStore } from '@/services/project-v2/stores/project-detail-page-store';
import type { WebhookType } from '@/services/project-v2/types/project-alert-type';
...
const singleItemTabState = reactive({
    ...
    activeTab: PROJECT_ROUTE_V2.DETAIL.TAB.SUMMARY._NAME,
});
...
watch(() => route.name, (routeName) => {
    ...
    if (routeName === PROJECT_ROUTE_V2.DETAIL.TAB.DASHBOARD._NAME) {
        singleItemTabState.activeTab = route.params.dashboardId;
    } else {
        singleItemTabState.activeTab = exactRoute?.name || PROJECT_ROUTE_V2.DETAIL.TAB.SUMMARY._NAME;
    }
}, { immediate: true });
watch([
    () => props.id,
