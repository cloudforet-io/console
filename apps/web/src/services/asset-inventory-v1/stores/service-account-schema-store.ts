...
import { getAccountFields, getCustomTableSchema } from '@/services/asset-inventory-v1/helpers/dynamic-ui-schema-generator';
import { getDefaultDetailSchema, getDefaultSearchSchema, getDefaultTableSchema } from '@/services/asset-inventory-v1/helpers/dynamic-ui-schema-generator/dynamic-layout-schema-template';
import type { ItemLayout, QuerySearchTableLayout } from '@/services/asset-inventory-v1/helpers/dynamic-ui-schema-generator/type';
