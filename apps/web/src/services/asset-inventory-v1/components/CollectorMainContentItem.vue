...
import CollectorItemSchedule
    from '@/services/asset-inventory-v1/components/CollectorMainItemSchedule.vue';
...
import type { CollectorItemInfo, JobAnalyzeStatus } from '@/services/asset-inventory-v1/types/collector-main-page-type';
