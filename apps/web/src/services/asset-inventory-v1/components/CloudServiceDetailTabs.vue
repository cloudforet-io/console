...
import CloudServiceMultipleSelectedData
    from '@/services/asset-inventory-v1/components/CloudServiceDetailMultipleSelectedData.vue';
import CloudServiceHistory
    from '@/services/asset-inventory-v1/components/CloudServiceHistory.vue';
