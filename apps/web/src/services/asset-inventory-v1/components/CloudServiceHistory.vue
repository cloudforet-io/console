...
import CloudServiceHistoryDateSelectDropdown
    from '@/services/asset-inventory-v1/components/CloudServiceHistoryDateSelectDropdown.vue';
import CloudServiceHistoryDetailOverlay
    from '@/services/asset-inventory-v1/components/CloudServiceHistoryDetailOverlay.vue';
...
} from '@/services/asset-inventory-v1/types/cloud-service-detail-page-type';
