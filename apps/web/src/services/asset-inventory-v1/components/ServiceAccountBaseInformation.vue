...
import ServiceAccountBaseInformationDetail
    from '@/services/asset-inventory-v1/components/ServiceAccountBaseInformationDetail.vue';
import ServiceAccountBaseInformationForm
    from '@/services/asset-inventory-v1/components/ServiceAccountBaseInformationForm.vue';
...
} from '@/services/asset-inventory-v1/types/service-account-page-type';
