...
import MultipleProviderForm
    from '@/services/asset-inventory-v1/components/CollectorCreateMultipleProviderForm.vue';
import CollectorNameForm from '@/services/asset-inventory-v1/components/CollectorFormName.vue';
...
import CollectorPluginContents
    from '@/services/asset-inventory-v1/components/CollectorPluginContents.vue';
