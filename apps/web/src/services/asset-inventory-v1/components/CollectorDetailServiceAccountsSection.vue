...
import AttachedServiceAccounts
    from '@/services/asset-inventory-v1/components/CollectorDetailAttachedServiceAccounts.vue';
import CollectorDetailSectionHeader from '@/services/asset-inventory-v1/components/CollectorDetailSectionHeader.vue';
import AttachedServiceAccountForm from '@/services/asset-inventory-v1/components/CollectorFormAttachedServiceAccount.vue';
