...
import ServiceAccountCredentialsDetail
    from '@/services/asset-inventory-v1/components/ServiceAccountCredentialsDetail.vue';
import ServiceAccountCredentialsForm
    from '@/services/asset-inventory-v1/components/ServiceAccountCredentialsForm.vue';
