...
import CollectorDataDefaultInner
    from '@/services/asset-inventory-v1/components/CollectorDataDefaultInner.vue';
import CollectorDataDuplicationInner
    from '@/services/asset-inventory-v1/components/CollectorDataDuplicationInner.vue';
import { COLLECT_DATA_TYPE, JOB_STATE } from '@/services/asset-inventory-v1/constants/collector-constant';
import {
