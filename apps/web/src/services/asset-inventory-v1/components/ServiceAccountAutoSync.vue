...
import ServiceAccountAutoSyncDetail from '@/services/asset-inventory-v1/components/ServiceAccountAutoSyncDetail.vue';
...
import type { PageMode } from '@/services/asset-inventory-v1/types/service-account-page-type';
