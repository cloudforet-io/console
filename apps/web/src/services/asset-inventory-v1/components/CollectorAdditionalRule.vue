...
import CollectorAdditionalRuleContent from '@/services/asset-inventory-v1/components/CollectorAdditionalRuleContent.vue';
import CollectorAdditionalRuleEmptyCase
    from '@/services/asset-inventory-v1/components/CollectorAdditionalRuleEmptyCase.vue';
import CollectorAdditionalRuleForm from '@/services/asset-inventory-v1/components/CollectorAdditionalRuleForm.vue';
...
import type { CollectorRuleForm } from '@/services/asset-inventory-v1/types/type';
