...
import CollectorDetailPluginInfo from '@/services/asset-inventory-v1/components/CollectorDetailPluginInfo.vue';
import PluginSummaryCards from '@/services/asset-inventory-v1/components/CollectorDetailPluginSummaryCards.vue';
import CollectorDetailSectionHeader from '@/services/asset-inventory-v1/components/CollectorDetailSectionHeader.vue';
import CollectorTags from '@/services/asset-inventory-v1/components/CollectorDetailTags.vue';
import CollectorTagForm from '@/services/asset-inventory-v1/components/CollectorFormTag.vue';
import CollectorVersionForm from '@/services/asset-inventory-v1/components/CollectorFormVersion.vue';
import { useCollectorDetailPageStore } from '@/services/asset-inventory-v1/stores/collector-detail-page-store';
