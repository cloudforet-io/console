...
import JobBasicInformation from '@/services/asset-inventory-v1/components/CollectorHistoryJobBasicInformation.vue';
import JobStatusChart from '@/services/asset-inventory-v1/components/CollectorHistoryJobStatusChart.vue';
import JobTaskDetails from '@/services/asset-inventory-v1/components/CollectorHistoryJobTaskDetails.vue';
import JobTable from '@/services/asset-inventory-v1/components/CollectorHistoryJobTaskTable.vue';
