...
import NoCollectorModal from '@/services/asset-inventory-v1/components/CollectorHistoryNoCollectorModal.vue';
...
<template>
    <div class="collector-history-page">
        ...
        <no-collector-modal :visible.sync="state.modalVisible"
                            @confirm="$router.push({ name: ADMIN_ASSET_INVENTORY_ROUTE_V1.COLLECTOR.CREATE._NAME })"
        />
    </div>
</template>
