...
import CollectDataButtonGroup
    from '@/services/asset-inventory-v1/components/CollectorDetailCollectDataButtonGroup.vue';
import CollectorNameEditModal
    from '@/services/asset-inventory-v1/components/CollectorDetailNameEditModal.vue';
...
const { setPathFrom, handleClickBackButton } = useGoBack({ name: ASSET_INVENTORY_ROUTE_V1.COLLECTOR._NAME });
