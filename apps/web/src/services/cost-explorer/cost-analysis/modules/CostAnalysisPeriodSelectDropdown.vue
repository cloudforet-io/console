...
const state = reactive({
    ...
    monthlyPeriodItems: computed<PeriodItem[]>(() => ([
        ...
        {
            name: 'last12Months',
            label: t('BILLING.COST_MANAGEMENT.COST_ANALYSIS.PERIOD.LAST_12_MONTHS'),
            relativePeriod: { unit: 'month', value: 11, include_today: true },
        },
        {
            name: 'ThisYear',
            label: t('BILLING.COST_MANAGEMENT.COST_ANALYSIS.PERIOD.THIS_YEAR'),
            relativePeriod: { unit: 'year', value: 0, include_today: true },
        },
        {
            name: 'lastYear',
            label: t('BILLING.COST_MANAGEMENT.COST_ANALYSIS.PERIOD.LAST_YEAR'),
            relativePeriod: { unit: 'year', value: 1, include_today: false },
        }])),
    yearlyPeriodItems: computed<PeriodItem[]>(() => ([
        {
            name: 'last3Years',
            label: t('BILLING.COST_MANAGEMENT.COST_ANALYSIS.PERIOD.LAST_3_YEARS'),
