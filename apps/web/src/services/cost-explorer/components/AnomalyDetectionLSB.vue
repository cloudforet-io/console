...
const MENU_ITEMS = [
    {
        name: i18n.t('BILLING.COST_MANAGEMENT.ANOMALY_DETECTION.CONFIG_TITLE'),
        to: COST_EXPLORER_ROUTE.ANOMALY_DETECTION.CONFIGURATION._NAME,
        id: MENU_ID.ANOMALY_DETECTION_CONFIGURATION,
    },
    {
        name: i18n.t('BILLING.COST_MANAGEMENT.ANOMALY_DETECTION.POLICY_TITLE'),
        to: COST_EXPLORER_ROUTE.ANOMALY_DETECTION.POLICY._NAME,
        id: MENU_ID.ANOMALY_DETECTION_POLICY,
    },
    {
        name: i18n.t('BILLING.COST_MANAGEMENT.ANOMALY_DETECTION.HISTORY_TITLE'),
