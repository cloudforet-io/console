...
export const COST_EXPLORER_ROUTE = Object.freeze({
    ...
    COST_ANOMALY_DETECTION: {
        _NAME: `${MENU_ID.COST_EXPLORER}.${MENU_ID.COST_ANOMALY_DETECTION}`,
        CONFIGURATION: { _NAME: `${MENU_ID.COST_EXPLORER}.${MENU_ID.COST_ANOMALY_DETECTION}.configuration` },
        POLICY: { _NAME: `${MENU_ID.COST_EXPLORER}.${MENU_ID.COST_ANOMALY_DETECTION}.policy` },
        HISTORY: { _NAME: `${MENU_ID.COST_EXPLORER}.${MENU_ID.COST_ANOMALY_DETECTION}.history` },
    },
    BUDGET: {
