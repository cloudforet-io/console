...
import AlertDetailInfoTableProject from '@/services/alert-manager-v2/components/AlertDetailInfoTableProject.vue';
import AlertTriggeredBy from '@/services/alert-manager-v2/components/AlertMainDataTableTriggeredByField.vue';
