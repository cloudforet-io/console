...
const handleClickCardButton = (type: string) => {
    ...
    if (type === 'quick-start-guide') {
        url = storeState.language === 'en' ? 'https://cloudforet.io/docs/guides/admin-mode/getting-started' : `https://cloudforet.io/${storeState.language}/docs/guides/admin-mode/getting-started`;
