...
const emit = defineEmits<{(event: 'update', dateRange: DateRange): void;
    (event: 'update:dateRange', dateRange: DateRange): void;
}>();
...
<template>
    <div class="cost-analysis-period-select-dropdown"
         :class="{responsive: !props.printMode}"
    >
        ...
        <p-select-dropdown v-if="!props.printMode"
        ...
        <custom-date-range-modal v-if="state.customRangeModalVisible"
                                 :visible="state.customRangeModalVisible"
                                 :granularity="props.granularity"
                                 @confirm="handleCustomRangeModalConfirm"
                                 @update:visible="state.customRangeModalVisible = $event"
        />
    </div>
</template>
