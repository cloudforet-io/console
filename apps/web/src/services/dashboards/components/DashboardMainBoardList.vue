...
const convertBoardItemButtonSet = (dashboardItem: DashboardModel) => {
    const dashboardId = dashboardItem.dashboard_id || dashboardItem.private_dashboard_id || '';
    return [
        {
            iconName: 'ic_edit',
...
const handleClickBoardItem = (item: DashboardModel) => {
    router.push(getProperRouteLocation({
        ...
        params: {
            dashboardId: item.dashboard_id || item.private_dashboard_id || '',
        },
    }));
};
            ...
            <template #item-content="{board}">
                <div class="content-wrapper">
                    <div class="board-item-title-wrapper">
                        <div class="left-part">
                            <favorite-button :item-id="board.dashboard_id || board.private_dashboard_id"
