...
const state = reactive({
    ...
    steps: computed<Step[]>(() => [
        {
            step: 1,
            description: i18n.t('PROJECT.DASHBOARDS.CREATE.STEP1_DESC'),
        },
        {
            step: 2,
            description: i18n.t('PROJECT.DASHBOARDS.CREATE.STEP2_DESC'),
        },
    ]),
...
const { setPathFrom, handleClickBackButton } = useGoBack({
    ...
    params: {
        projectGroupOrProjectId: route.params.projectGroupOrProjectId,
    },
});
