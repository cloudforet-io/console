...
const emit = defineEmits<{(e: 'confirm', maintenanceWindowId: string): void;
    (e: 'close', maintenanceWindowId: string): void;
...
<template>
    <p-button-modal :header-title="props.editMode ?
    ...
    >
        <template #body>
            ...
            >
                <p-radio v-for="{name, label} in state.scheduleRadioItems"
                         :key="name"
                         v-model="state.selectedScheduleType"
                         :value="name"
        ...
        >
            <p-button style-type="negative-secondary"
                      size="lg"
                      @click="handleClickClose(props.maintenanceWindowId)"
            >
