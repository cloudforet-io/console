...
const createMember = async () => {
    try {
        ...
        if (props.isProjectGroup) {
            ...
            showSuccessMessage(t('PROJECT.DETAIL.ALT_S_UPDATE_GROUP_MEMBER'), '');
        } else {
            params.project_id = props.projectId;
            await SpaceConnector.client.identity.project.member.add(params);
            showSuccessMessage(t('PROJECT.DETAIL.ALT_S_UPDATE_MEMBER'), '');
        }
    } catch (e) {
        ErrorHandler.handleRequestError(e, t('PROJECT.DETAIL.ALT_E_UPDATE_MEMBER'));
    }
};
...
/* Event */
const handleUpdateLabel = (inputLabels: MenuItem[], isValid: boolean) => {
