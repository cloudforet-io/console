    ...
    finishConditions: computed(() => ([
        {
            ...
            label: t('PROJECT.DETAIL.ALERT.ACKNOWLEDGED'),
        },
        {
            name: FINISH_CONDITION.resolved,
            label: t('PROJECT.DETAIL.ALERT.RESOLVED'),
        },
    ])),
        ...
        <section>
            ...
            <div class="escalation-rules-wrapper">
                <div class="rule-wrapper">
                    ...
                    >
                        ...
                        <template v-if="rule.escalate_minutes">
                            ...
                            <span class="text">
                                <i18n-t keypath="PROJECT.DETAIL.ALERT.ESCALATES_AFTER">
                                    <template #minute>
                ...
                <div class="repeat-wrapper">
                    <p-i name="ic_repeat" />
                    <i18n-t keypath="PROJECT.DETAIL.ALERT.REPEAT_ALL"
                            class="ml-2"
                    >
                        <template #count>
