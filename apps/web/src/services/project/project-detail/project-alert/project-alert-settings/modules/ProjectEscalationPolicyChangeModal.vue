    ...
    tabs: computed(() => ([
        {
            ...
            label: t('PROJECT.DETAIL.ALERT.SELECT_POLICY'),
        },
        {
            name: FORM_MODE.create,
            label: t('PROJECT.DETAIL.ALERT.CREATE_NEW_POLICY'),
        },
    ])),
...
const createEscalationPolicy = async (): Promise<string | undefined> => {
    try {
        ...
        ErrorHandler.handleRequestError(e, t('PROJECT.DETAIL.ALERT.ALT_E_CHANGE_ESCALATION_POLICY'));
        return undefined;
    }
};
...
const handleClickConfirm = async () => {
    ...
    if (newEscalationPolicyId) {
        ...
        showSuccessMessage(t('PROJECT.DETAIL.ALERT.ALT_S_CHANGE_ESCALATION_POLICY'), '');
    }
    emit('confirm');
                ...
                >
                    <template #select>
                        <escalation-policy-data-table
                            ...
                            v-model:select-index="tableState.selectIndex"
