...
const state = reactive({
    ...
    dateTypes: computed(() => ([
        { name: DATE_TYPE.DAILY, label: t('COMMON.WIDGETS.ALL_SUMMARY.DAY') },
        { name: DATE_TYPE.MONTHLY, label: t('COMMON.WIDGETS.ALL_SUMMARY.MONTH') },
    ])),
    //
    ...
    labelMap: computed(() => ({
        [SERVICE_CATEGORY.SERVER]: t('COMMON.WIDGETS.ALL_SUMMARY.SERVER'),
        [SERVICE_CATEGORY.CONTAINER]: t('COMMON.WIDGETS.ALL_SUMMARY.CONTAINER'),
        [SERVICE_CATEGORY.DATABASE]: t('COMMON.WIDGETS.ALL_SUMMARY.DATABASE'),
        [SERVICE_CATEGORY.NETWORKING]: t('COMMON.WIDGETS.ALL_SUMMARY.NETWORKING'),
        [SERVICE_CATEGORY.STORAGE]: t('COMMON.WIDGETS.ALL_SUMMARY.STORAGE'),
        [SERVICE_CATEGORY.SECURITY]: t('COMMON.WIDGETS.ALL_SUMMARY.SECURITY'),
        [SERVICE_CATEGORY.ANALYTICS]: t('COMMON.WIDGETS.ALL_SUMMARY.ANALYTICS'),
        [SERVICE_CATEGORY.ALL]: t('COMMON.WIDGETS.ALL_SUMMARY.ALL'),
    })),
    countMap: {},
