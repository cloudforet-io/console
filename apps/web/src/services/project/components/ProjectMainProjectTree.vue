...
import type {
    ProjectGroupChangeParentGroupRequestParameters,
...
import type { ProjectChangeProjectGroupRequestParameters } from '@/schema/identity/project/api-verbs/change-project-group';
...
const onFinishEdit = async (node, editText: string) => {
    try {
        const params: ProjectGroupUpdateRequestParameters = {
...
const updateProjectGroup = async (node, oldParent, parent) => {
    const params: ProjectGroupChangeParentGroupRequestParameters = {
        project_group_id: node.data.id,
...
const updateProject = async (node, oldParent, parent) => {
    try {
        const params: ProjectChangeProjectGroupRequestParameters = {
