...
import TaskFieldForm from '@/services/ops-flow/task-field-forms/TaskFieldForm.vue';
</script>

<template>
    <div class="pt-6 px-4 pb-10">
        <p-pane-layout class="py-6 px-4 flex flex-wrap gap-4">
            <div class="flex-1 flex mobile:flex-wrap gap-4">
                <div class="flex-1 min-w-40 mobile:min-w-full flex flex-col gap-1">
