...
import { getUpdatedWidgetInfo } from '@/services/dashboard-shared/dashboard-detail/helpers/dashboard-widget-info-helper';
import { mergeBaseWidgetState } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/merge-base-widget-state';
import { getWidgetOptionsSchema } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-options-schema-generator';
import type { UpdatableWidgetInfo } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-type';
