...
import DashboardVariablesFormDynamic
    from '@/services/dashboard-shared/dashboard-detail/components/DashboardVariablesFormDynamic.vue';
import DashboardVariablesFormManual
    from '@/services/dashboard-shared/dashboard-detail/components/DashboardVariablesFormManual.vue';
