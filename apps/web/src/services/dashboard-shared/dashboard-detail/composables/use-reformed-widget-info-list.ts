...
import {
    widgetThemeAssigner,
} from '@/services/dashboard-shared/dashboard-detail/helpers/widget-theme-helper';
import {
    widgetWidthAssigner,
} from '@/services/dashboard-shared/dashboard-detail/helpers/widget-width-helper';
import { getWidgetComponent } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-component-helper';
import { getWidgetConfig } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-config-helper';
import type { WidgetTheme } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-type';
