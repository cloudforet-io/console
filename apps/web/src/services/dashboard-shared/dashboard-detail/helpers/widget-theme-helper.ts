import type { WidgetThemeOption, WidgetThemeAssignedList } from '@/services/dashboard-shared/dashboard-detail/constants/widget-container-config';
import { WIDGET_THEMES } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-type';
