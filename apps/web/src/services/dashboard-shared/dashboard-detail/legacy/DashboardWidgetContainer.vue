...
import { useDashboardContainerWidth } from '@/services/dashboard-shared/dashboard-detail/composables/use-dashboard-container-width';
import { useDashboardGetQuery } from '@/services/dashboard-shared/dashboard-detail/composables/use-dashboard-get-query';
import type { ReformedWidgetInfo } from '@/services/dashboard-shared/dashboard-detail/composables/use-reformed-widget-info-list';
import { useReformedWidgetInfoList } from '@/services/dashboard-shared/dashboard-detail/composables/use-reformed-widget-info-list';
import { getDashboardWidgetInfoList } from '@/services/dashboard-shared/dashboard-detail/helpers/dashboard-widget-info-helper';
import type { WidgetFrameProps } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_components/WidgetFrame.vue';
import type { WidgetExpose } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-type';
