...
import { MANAGED_WIDGET_FILTERS_SCHEMA_PROPERTIES } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_constants/managed-widget-options-schema';
