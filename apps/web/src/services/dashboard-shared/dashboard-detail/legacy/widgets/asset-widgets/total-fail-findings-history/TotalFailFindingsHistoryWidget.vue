...
import { SEVERITY_STATUS_MAP } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_constants/compliance-constant';
import { getDateAxisSettings } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-chart-helper';
import type { Severity } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/compliance-type';
import type { WidgetProps, WidgetExpose, WidgetEmit } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-type';
