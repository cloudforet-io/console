...
import type { ComplianceStatus, Severity } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/compliance-type';
import type { WidgetExpose, WidgetProps, WidgetEmit } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-type';
