...
import WidgetDataTable from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_components/WidgetDataTable.vue';
import WidgetFrame from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_components/WidgetFrame.vue';
import { useWidgetColorSet } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget-color-set';
import { useWidgetLifecycle } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget-lifecycle';
import { useWidgetPagination } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget-pagination';
import { useWidget } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/use-widget';
import { getRefinedPieChartData } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-chart-data-helper';
import {
    getPieChartLegends,
} from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-chart-helper';
import { getWidgetDataTableRowLocation } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-location-helper';
import { getReferenceTypeOfDataField } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-table-helper';
import type { Field, WidgetTableData } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-data-table-type';
import type {
    WidgetExpose, WidgetProps, WidgetEmit, Legend, CostAnalyzeResponse,
} from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-type';
