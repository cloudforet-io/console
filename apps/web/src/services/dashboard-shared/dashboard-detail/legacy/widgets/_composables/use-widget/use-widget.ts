...
import type {
    BaseWidgetState,
} from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/use-base-widget-state';
import { useBaseWidgetState } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/use-base-widget-state';
import { useWidgetConsoleFilters } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/use-widget-console-filters';
import { useWidgetDateRange } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/use-widget-date-range';
import { useWidgetFrame } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/use-widget-frame';
import { useWidgetLocation } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/use-widget-location';
