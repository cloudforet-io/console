...
import WidgetChartNoDataOverlay from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_components/WidgetChartNoDataOverlay.vue';
...
import { COMPLIANCE_STATUS_MAP } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_constants/compliance-constant';
import {
    getDateAxisSettings,
...
} from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-table-helper';
import type { Field } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-data-table-type';
import type {
