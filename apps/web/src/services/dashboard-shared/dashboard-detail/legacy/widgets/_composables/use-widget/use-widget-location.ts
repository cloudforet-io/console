...
import type { BaseWidgetState } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/use-base-widget-state';
import type { OverridableWidgetState } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_composables/use-widget/use-widget';
import { getWidgetLocationFilters } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_helpers/widget-location-helper';
import type { WidgetProps } from '@/services/dashboard-shared/dashboard-detail/legacy/widgets/_types/widget-type';
