...
interface UseDashboardUpdateActionOptions {
...
export const useDashboardUpdateAction = (options: UseDashboardUpdateActionOptions) => {
    ...
    const updateDashboardFn = (params: DashboardUpdateParams): Promise<DashboardModel> => {
        ...
        const fetcher = isPrivate.value ? privateDashboardAPI.update : publicDashboardAPI.update;
