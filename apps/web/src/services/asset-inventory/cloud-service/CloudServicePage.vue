...
const init = async () => {
    ...
    const urlQueryValue: CloudServicePageUrlQueryValue = {
        ...
        filters: searchQueryHelper.setKeyItemSets(handlerState.keyItemSets).setFiltersAsRawQueryString(currentQuery.filters as undefined|string|(string|null)[]).filters,
    };
...
<template>
    <div class="page-wrapper">
        ...
        <cloud-service-toolbox :total-count="state.totalCount"
