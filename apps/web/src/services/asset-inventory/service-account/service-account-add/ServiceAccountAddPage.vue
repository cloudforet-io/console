...
const createServiceAccount = async (): Promise<string|undefined> => {
    try {
        ...
        ErrorHandler.handleRequestError(e, t('IDENTITY.SERVICE_ACCOUNT.ADD.ALT_E_CREATE_ACCOUNT_TITLE'));
        return undefined;
    } finally {
...
const createSecret = async (serviceAccountId: string): Promise<boolean> => {
    ...
    try {
        ...
        showSuccessMessage(t('IDENTITY.SERVICE_ACCOUNT.ADD.ALT_S_CREATE_ACCOUNT_TITLE'), '');
        isSucceed = true;
    } catch (e) {
        isSucceed = false;
        ErrorHandler.handleRequestError(e, t('IDENTITY.SERVICE_ACCOUNT.ADD.ALT_E_CREATE_ACCOUNT_TITLE'));
...
const handleSave = async () => {
    if (!formState.isValid) {
        ErrorHandler.handleRequestError(t('IDENTITY.SERVICE_ACCOUNT.ADD.ALT_E_CREATE_ACCOUNT_FORM_INVALID'), t('IDENTITY.SERVICE_ACCOUNT.ADD.ALT_E_CREATE_ACCOUNT_TITLE'));
        return;
    }
    ...
    router.push({ name: ASSET_INVENTORY_ROUTE.SERVICE_ACCOUNT._NAME, query: { provider: props.provider } });
};
const handleGoBack = () => {
    const nextPath = router.currentRoute.value.query.nextPath as string|undefined;
...
<template>
    <div class="service-account-add-page">
        ...
        <div class="content-wrapper">
            <service-account-account-type v-model:account-type="accountType"
                                          :provider="provider"
            ...
            <p-pane-layout class="form-wrapper">
                ...
                />
                <service-account-base-information-form v-model:is-valid="formState.isBaseInformationFormValid"
            ...
            >
                ...
                <service-account-project-form
                    v-model:is-valid="formState.isProjectFormValid"
            ...
            >
                ...
                <service-account-credentials-form
                    v-model:is-valid="formState.isCredentialFormValid"
