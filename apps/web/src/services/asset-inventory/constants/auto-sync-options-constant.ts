import { AZURE_MANAGEMENT_GROUP_MAPPING_TYPE } from '@/schema/identity/trusted-account/constant';

export const WORKSPACE_MAPPING_OPTIONS_MAP = {
    MULTI: 'multi',
    SINGLE: 'single',
    TOP_AZURE_MANAGEMENT_GROUP_MAPPING: AZURE_MANAGEMENT_GROUP_MAPPING_TYPE.TOP_MANAGEMENT_GROUP,
    LEAF_AZURE_MANAGEMENT_GROUP_MAPPING: AZURE_MANAGEMENT_GROUP_MAPPING_TYPE.LEAF_MANAGEMENT_GROUP,
} as const;
