...
import WebhookCreateTypeSelector from '@/services/alert-manager/components/WebhookCreateTypeSelector.vue';
...
import type { createHeaderInfoByStep } from '@/services/alert-manager/types/alert-manager-type';
