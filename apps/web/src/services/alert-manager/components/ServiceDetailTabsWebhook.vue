...
import ServiceDetailTabsWebhookDeleteModal
    from '@/services/alert-manager/components/ServiceDetailTabsWebhookDeleteModal.vue';
import ServiceDetailTabsWebhookTableModal
    from '@/services/alert-manager/components/ServiceDetailTabsWebhookTableModal.vue';
import ServiceDetailTabsWebhookUpdateModal
    from '@/services/alert-manager/components/ServiceDetailTabsWebhookUpdateModal.vue';
...
import type { WebhookModalType } from '@/services/alert-manager/types/alert-manager-type';
