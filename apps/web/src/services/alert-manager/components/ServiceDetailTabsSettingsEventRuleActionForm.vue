...
import ServiceDetailTabsSettingsEventRuleActionAlert
    from '@/services/alert-manager/components/ServiceDetailTabsSettingsEventRuleActionAlert.vue';
import ServiceDetailTabsSettingsEventRuleActionAsset
    from '@/services/alert-manager/components/ServiceDetailTabsSettingsEventRuleActionAsset.vue';
