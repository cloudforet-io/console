...
import ServiceDetailTabsSettingsEscalationPolicyForm
    from '@/services/alert-manager/components/ServiceDetailTabsSettingsEscalationPolicyForm.vue';
import { SERVICE_DETAIL_TABS } from '@/services/alert-manager/constants/common-constant';
import { useServiceDetailPageStore } from '@/services/alert-manager/stores/service-detail-page-store';
import type { EscalationPolicyRadioType, EscalationPolicyModalType } from '@/services/alert-manager/types/alert-manager-type';
