...
import type { AlertStateFilter, AlertUrgency, AssignedState } from '@/services/alert-manager/lib/config';
import {
...
const emit = defineEmits<{(e: 'update', value: Partial<AlertListTableFilters>):void;
    (e: 'change-list'): void
}>();
