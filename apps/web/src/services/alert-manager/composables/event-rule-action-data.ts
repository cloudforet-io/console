...
import { EVENT_RULE_SETTINGS_TYPE } from '@/services/alert-manager/constants/common-constant';
import type { EventRuleSettingsType } from '@/services/alert-manager/types/alert-manager-type';
