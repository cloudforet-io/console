                        ...
                        >
                            <div class="left-part">
                                <div v-if="rowNum > -1"
                                     class="label-wrapper"
                                >
                                    <p-i :name="state.tableData[rowNum].icon"
                                         width="0.875rem"
                                         height="0.875rem"
                                         color="inherit transparent"
                                    />
                                    <span class="text hidden lg:inline-block">{{ state.tableData[rowNum].label }}</span>
                                </div>
                            </div>
                            <div class="right-part grid grid-cols-12 gap-1">
                                ...
                                >
                                    ...
                                    <template v-else>
                                        <router-link v-if="getProjectBoxCount(rowNum, colNum * state.thisPage - 1) > 0"
                                                     :to="projectSummaryLinkFormatter(rowNum, colNum * state.thisPage - 1)"
                                        >
                                            <div class="box"
                                                 :class="getProjectBoxStatus(rowNum, colNum * state.thisPage - 1)"
                                            >
                                                <span class="box-text">{{ getProjectBoxCount(rowNum, colNum * state.thisPage - 1) }}</span>
                                            </div>
                                        </router-link>
                                        <div v-else
                                             class="box empty"
