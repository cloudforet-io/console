...
const state = reactive({
    ...
    dateTypes: computed<DateItem[]>(() => ([
        { name: 'DAILY', label: t('COMMON.WIDGETS.ALL_SUMMARY.DAY') },
        { name: 'MONTHLY', label: t('COMMON.WIDGETS.ALL_SUMMARY.MONTH') },
    ])),
    //
    loading: true,
    count: {
    ...
    tabs: computed<TabItem[]>(() => [
        {
            ...
            label: t('COMMON.WIDGETS.ALL_SUMMARY.SERVER'),
        },
        {
            name: DATA_TYPE.DATABASE,
            label: t('COMMON.WIDGETS.ALL_SUMMARY.DATABASE'),
        },
        {
            name: DATA_TYPE.STORAGE,
            label: t('COMMON.WIDGETS.ALL_SUMMARY.STORAGE'),
        },
        {
