...
const SignInContainer = () => import('@/services/auth/sign-in/modules/SignInContainer.vue');
...
const MultiFactorAuthenticationPage = () => import('@/services/auth/sign-in/MultiFactorAuthenticationPage.vue');
