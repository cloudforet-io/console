...
const state = reactive({
    scheduleMode: computed(() => [{
        label: t('IDENTITY.USER.NOTIFICATION.FORM.ALL_TIME'), value: false,
    }, {
        label: t('IDENTITY.USER.NOTIFICATION.FORM.CUSTOM'), value: true,
    }]),
...
<template>
    <div>
        ...
        >
            ...
            <p-select-button v-for="day in state.weekDay"
                             :key="day.value"
                             :selected="dayOfWeek"
                             multi-selectable
                             :value="day.value"
            ...
            <div class="dropdown-wrapper">
                ...
                />
                <span class="timezone-text">{{ t('COMMON.PROFILE.TIMEZONE') }}: {{ state.timezone }}</span>
            </div>
        </article>
    </div>
</template>
